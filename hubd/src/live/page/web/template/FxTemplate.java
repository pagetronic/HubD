...
public class FxTemplate {
	...
	public static String avatar(String src, boolean itemprop) {
		String prod = "<picture>";
		prod += "<source width=\"40\" height=\"40\" srcset=\"" + src + "@40x40\" media=\"(min-width: 701px) and (max-width: 900px)\" />";
		prod += "<source width=\"25\" height=\"25\" srcset=\"" + src + "@25x25\" media=\"(max-width: 700px)\" />";
		prod += "<img ";
		if (itemprop) {
			prod += "itemprop=\"image\" ";
		}
