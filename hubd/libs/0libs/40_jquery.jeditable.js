 ...
 * Modified by Laurent PAGE on december 2018 for TextBoxLive
 */
$.fn.editable = function (target, options) {
    ...
    return this.each(function () {
        ...
        /*
         * Inlined block elements lose their width and height after first
         * edit.
         */
        ...
        $(this).bind(settings.event, function (e) {
            ...
            if (settings.uitools) {
                if ('inherit' === style) {
                    ...
                    /*
                     * IE needs the second line or display wont be
                     * inherited.
                     */
                    form.css('display', $(self).css('display'));
                } else {
                    form.attr('style', style);
                }
            }
            ...
            /*
             * Set input content via POST, GET, given data or existing
             * value.
             */
            var input_content;
            ...
            /*
             * Discard, submit or nothing with changes when clicking
             * outside.
             */
                ...
                if (false !== onsubmit.apply(form, [settings, self])) {
                    ...
                    if (false !== submit.apply(form, [settings, self])) {
                        ...
                        if ($.isFunction(settings.target)) {
                            ...
                            /*
                             * Add edited content and id of edited element
                             * to POST.
                             */
                            var data = {};
                            data[settings.name] = input.val();
                            if (self.id !== undefined && self.id !== '') {
                                data[settings.id] = self.id;
                            }
                            /* Add extra data to be POST:ed. */
                            if ($.isFunction(settings.data)) {
                                $.extend(data, settings.data.apply(self, [self.revert, settings]));
                            } else {
                            ...
                            /* Api Post. */
                            api.post(settings.target, data, function (result, status) {
...
$.fn.editable.defaults = {
    ...
    onblur: 'cancel',
    loadtype: 'GET',
    loadtext: lang.get('LOADING'),
    placeholder: '',
    tooltip: lang.get('CLICK_TO_EDIT'),
    loaddata: {},
    data: {}
};
