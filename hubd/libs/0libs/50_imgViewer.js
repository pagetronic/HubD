...
//		the original img element
             ...
             */
            self.zimg = $("<img />", {"src": self.img.src}).appendTo("body").wrap('<div class="zoomport" />');

            if (self.options.legend !== '') {
                self.zimg.after($('<div />').css({
                    position: 'absolute',
                    width: '100%',
                    fontSize: '15px',
                    color: '#FFF',
                ...
                }).html($('<div />').css({margin: 'auto', maxWidth: '80%'}).html(self.options.legend.replace('©','<br/>©'))));
            }
            var $zimg = $(self.zimg);
//		the container or zoomport for the image view
            self.view = $(self.zimg).parent();
            var $view = $(self.view);
//		the pixel coordinate of the original image at the center of the zoomport
            self.vCenter = {};
...
//				e.stopPropagation();
        ...
        /*
         *	Convert a relative image location to a zoomport pixel location
         */
        ...
        /*
         *	Convert a zoomport pixel location to a relative image coordinate
         */
