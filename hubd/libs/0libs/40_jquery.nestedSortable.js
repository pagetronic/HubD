...
(function (factory) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		options: {
			...
			disableNestingClass: "_no-nesting",
			errorClass: "_error",
			expandedClass: "_expanded",
			hoveringClass: "_hovering",
			leafClass: "_leaf",
					...
					if ($li.children(self.options.listType).length) {
						...
						if (!hasCollapsedClass && !hasExpandedClass) {
							if (self.options.startCollapsed) {
								...
								self.options.collapse($li);
							} else {
								$li.addClass(self.options.expandedClass);
								self.options.expand($li);
							}
						}
					} else {
							...
							if (this.currentItem[0].parentNode !== this.element[0] &&
								...
								if (!$(itemElement).children(o.listType).length) {
									...
									if (o.isTree) {
										...
										self.options.expand($(itemElement));
									}
								}
								...
								self.options.collapse($(itemElement));
							}
			...
			if (parentItem != null &&
				...
				if (!previousItem.children(o.listType).length) {
					...
					if (o.isTree) {
						...
						self.options.expand(previousItem);
					}
				}
